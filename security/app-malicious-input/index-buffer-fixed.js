...
// converts the input into base64 and adds it to an array
function friends () {
  return JSON.stringify(friends.list)
}

// Buffer.from method will throw when passed a number, it will only allow strings,
// arrays (and array-like objects), and other buffers (including Buffer and
// ArrayBuffer objects).
